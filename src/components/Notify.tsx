  ...
  return (
    <div className=" mt-5">
      <div className="space-y-5">
        <div className="relative mx-auto max-w-[400px] rounded-xl border border-secondary-50 bg-white p-4 text-sm shadow-lg">
          ...
          <div className="flex space-x-4">
            ...
            <div className="flex-1">
              <h4 className="pr-6 font-medium text-secondary-900">
                Updates have been made to your profile
              </h4>
              <div className="mt-1 text-secondary-500">
                Your team has made changes to your company profile since you
                last logged in.
              </div>
              <div className="mt-2 flex space-x-4">
                <button className="inline-block font-medium leading-loose text-secondary-500 hover:text-secondary-900">
                  Dismiss
                </button>
                <button className="inline-block font-medium leading-loose text-primary-600 hover:text-primary-700">
                  View more
                </button>
              </div>
            </div>
        ...
        <div className="relative mx-auto max-w-[400px] rounded-xl border border-secondary-50 bg-white p-4 text-sm shadow-lg">
          ...
          <div className="flex space-x-4">
            ...
            <div className="flex-1">
              <h4 className="pr-6 font-medium text-secondary-900">Warning</h4>
              <div className="mt-1 text-secondary-500">
                Your team has made changes to your company profile since you
                last logged in.
              </div>
